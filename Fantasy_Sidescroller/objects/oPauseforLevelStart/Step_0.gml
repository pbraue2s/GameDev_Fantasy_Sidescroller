if(keyboard_check_pressed(ord("E")) and !pause and collision_circle(oTeleportBookLevel1.x, oTeleportBookLevel1.y, oTeleportBookLevel1.radius, oCharacter, false, true)){
	instance_create_layer(camera_get_view_x(view_camera[0])-5, camera_get_view_y(view_camera[0])-5, "Menue", oPauseBackground);
	instance_create_layer(camera_get_view_x(view_camera[0])+72, camera_get_view_y(view_camera[0])+72, "MenueBook", oLevel1StartBook);
	...
	instance_create_layer(camera_get_view_x(view_camera[0])-5, camera_get_view_y(view_camera[0])-5, "Menue", oPauseBackground);
	instance_create_layer(camera_get_view_x(view_camera[0])+72, camera_get_view_y(view_camera[0])+72, "MenueBook", oLevel2StartBook);
	...
	instance_create_layer(camera_get_view_x(view_camera[0])-5, camera_get_view_y(view_camera[0])-5, "Menue", oPauseBackground);
	instance_create_layer(camera_get_view_x(view_camera[0])+72, camera_get_view_y(view_camera[0])+72, "MenueBook", oLevel3StartBook);
}else if(!pause){
